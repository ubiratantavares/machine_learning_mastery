...
# codificador-decodificador multivariado lstm para o conjunto de dados de uso de energia
...
def evaluate_model(train, test, n_input):
	...
	for i in range(len(test)):
		...
		# obter a observação real e adicionar ao histórico para prever a próxima semana.
