...
# codificador-decodificador unificado de várias etapas lstm para o conjunto de dados de uso de energia.
...
def build_model(train, n_input):
    ...
    # remodelar a saida para [amostras, etapas do tempo, recursos]
...
def evaluate_model(train, test, n_input):
	...
	for i in range(len(test)):
		...
		# obter a observação real e adicionar ao histórico para 
